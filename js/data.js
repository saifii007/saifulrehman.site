...
const PROJECTS = [
  ...
  },
  {
    ...
    architecture: "Multi-tenant SaaS architecture with multi-database subscription isolation per client.",
    challenges: "[ADD PROJECT CHALLENGES]",
    github: null,
    demo: null,
    real: true
  ...
  },
  {
    ...
    tagline: "Enterprise development project",
    description: "[ADD PROJECT DESCRIPTION — real project, named on saifulrehman.site, no written description supplied yet]",
    tech: [".NET", "Angular"],
    features: ["[ADD KEY FEATURES]"],
    architecture: "[ADD ARCHITECTURE NOTES]",
  ...
  },
  {
    ...
    tagline: "Solvefy project",
    description:
      "Management system built at Solvefy using ASP.NET Zero and Boilerplate frameworks with Angular and .NET for a scalable, multi-tenant architecture. [Full name of \"PMS\" unconfirmed — Property/Practice/Patient Management System? Please confirm.]",
  ...
  },
  {
    ...
    tagline: "Automation product — Solvefy",
    description: "Automation product built at Solvefy. [ADD fuller PROJECT DESCRIPTION — name confirmed, detail not yet supplied]",
    tech: [".NET", "Angular"],
    features: ["[ADD KEY FEATURES]"],
    architecture: "[ADD ARCHITECTURE NOTES]",
    challenges: "[ADD PROJECT CHALLENGES]",
  ...
  },
  {
    ...
    tagline: "Cedar Financial",
    description: "[ADD PROJECT DESCRIPTION — real project at Cedar Financial, name confirmed, detail not yet supplied]",
    tech: [".NET", "Angular"],
    features: ["[ADD KEY FEATURES]"],
    architecture: "[ADD ARCHITECTURE NOTES]",
    challenges: "[ADD PROJECT CHALLENGES]",
  ...
  },
  {
    ...
    categoryLabel: "Software Development",
    image: "assets/images/projects/react-dashboard1.jpg",
    tagline: "React-based consumer portal",
    description: "[ADD PROJECT DESCRIPTION — real project, named on saifulrehman.site, no written description supplied yet]",
    tech: ["React"],
    features: ["[ADD KEY FEATURES]"],
    architecture: "[ADD ARCHITECTURE NOTES]",
